defmodule Frontend.Accounts.User do
  use Ecto.Schema
  ...
  @doc """
  A generic changeset for the auto-generated user admin
  """
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Frontend.Repo)
  ...
  """
  def valid_password?(%Frontend.Accounts.User{hashed_password: hashed_password}, password)
