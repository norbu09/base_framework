defmodule FrontendWeb.UserAuthTest do
  use FrontendWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Frontend.Accounts
  alias FrontendWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FrontendWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FrontendWeb.Endpoint.subscribe(live_socket_id)
