defmodule FrontendWeb.Openid.UserinfoController do
  @behaviour Boruta.Openid.UserinfoApplication

  use FrontendWeb, :controller

  alias FrontendWeb.OpenidView

  def openid_module, do: Application.get_env(:frontend, :openid_module, Boruta.Openid)
