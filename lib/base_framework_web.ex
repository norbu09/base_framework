defmodule BaseFrameworkWeb do
  ...
  This can be used in your application as:
      ...
      use BaseFrameworkWeb, :controller
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: BaseFrameworkWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/base_framework_web/templates",
        namespace: BaseFrameworkWeb
